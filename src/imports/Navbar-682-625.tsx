import svgPaths from "./svg-n3smrndo5p";
...
function Navbar() {
  return (
    <div className="absolute content-stretch flex gap-[60px] h-[24.75px] items-center left-[765px] top-[29px] w-[334.305px]" data-name="Navbar">
      <Link />
      <Link1 />
      <Link2 />
    </div>
...
function Navbar1() {
  return (
    <div className="absolute content-stretch flex flex-col h-[26.25px] items-start left-[67px] top-[29px] w-[118.5px]" data-name="Navbar">
      <Image />
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col h-[3.999px] items-start left-[1780.01px] top-[32.31px] w-[63.98px]" data-name="Container">
      <Icon />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col h-[3.965px] items-start left-[1804.35px] top-[40.35px] w-[39.649px]" data-name="Container">
      <Icon1 />
    </div>
  );
}
...
function Container2() {
  return (
    <div className="absolute content-stretch flex flex-col h-[3.965px] items-start left-[1822.38px] top-[49.35px] w-[21.622px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
export default function Navbar2() {
  return (
    <div className="relative size-full" data-name="navbar">
      <div className="absolute border border-[#f6f6f6] border-solid h-[82px] left-0 top-0 w-[1920px]" />
      <div className="absolute border border-[#f6f6f6] border-solid h-[82px] left-0 top-0 w-[272px]" />
      <div className="absolute border border-[#f6f6f6] border-solid h-[82px] left-0 top-0 w-[1635px]" />
      <Navbar />
      <Navbar1 />
      <Container />
      <Container1 />
